...
class UserRedux extends Component {
    ...
    checkValidateInput = () => {
        let isValid = true;
        let arrCheck = ['email', 'password', 'firstName', 'lasatName', 
        'phoneNumber', 'address']
    ...
    render() {
        ...
        // Lấy giá trị cách thông minh
        let { email, password, firstName, lasatName, 
            phoneNumber, address, gender, 
            position, role, avatar } = this.state;

        // Lấy giá trị cách thổ dân
                    ...
                    <div className='container'>
                        <div className='row'>
                            ...
                            <div className='col-3'>
                                ...
                                <input className='form-control' type='text'
                                    value={lasatName}
                                    onChange={(event) => {this.onChangeInput(event, 'lasatName')}}
                                />
                            </div>
                            <div className='col-3'>
